                    ...
                    <>
                      ...
                      >
                        <strong className="text-xs font-semibold text-[#292A24] flex items-center gap-1.5">
                          <svg
                            className="w-3.5 h-3.5 text-[#32BCAD] shrink-0"
                            viewBox="0 0 512 512"
                            fill="currentColor"
                            aria-hidden="true"
                          >
                            <path d="M112.57 391.19c20.35 0 39.5-7.93 53.9-22.32l89.53-89.54 89.54 89.54c14.4 14.39 33.55 22.32 53.89 22.32h14.88l-94.88-94.89a27.64 27.64 0 0 1 0-39.1l94.88-94.89h-14.88c-20.34 0-39.49 7.93-53.89 22.33l-89.54 89.53-89.53-89.53c-14.4-14.4-33.55-22.33-53.9-22.33H97.69l94.89 94.89a27.64 27.64 0 0 1 0 39.1l-94.89 94.89h14.88z" />
                            <path d="M380.59 104.91c-31.57 0-61.27 12.3-83.6 34.63l-40.99 40.99-40.99-40.99c-22.33-22.33-52.03-34.63-83.6-34.63H68.82L179.9 216.01c22.04 22.05 22.04 57.93 0 79.98L68.82 407.09h62.59c31.57 0 61.27-12.3 83.6-34.63l40.99-40.99 40.99 40.99c22.33 22.33 52.03 34.63 83.6 34.63h62.59L332.1 295.99c-22.04-22.05-22.04-57.93 0-79.98l111.08-111.1h-62.59z" />
                          </svg>
